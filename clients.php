  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="listes des clients.php"><i class="fas fa-user"></i>Listes des Clients</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="ajouterClient.php"><i class="fas fa-bag-shopping"></i>Ajouter un Client</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex">
        ...
        <div class="sidebar">
          ...
          <a href="listes des clients.php"><i class="fas fa-user"></i>Listes des Clients</a>
  ...
  <tbody>
        ...
        $database = "ventestest";
          ...
          while($row = $result->fetch_assoc()) { ?>
            ...
            <td><?=$row["sexe"]?></td>
            <td>
                <a href='modifierClient.php'><div class='btn btn-info'>Modifier</div></a>
                <a href='deleteClient.php?numeroclient=<?=$row["numeroclient"]?>'>
