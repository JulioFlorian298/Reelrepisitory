  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="listes des produits.php"><i class="fas fa-user"></i>Listes des Produits</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="ajouterProduit.php"><i class="fas fa-bag-shopping"></i>Ajouter un Produit</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex">
        ...
        <div class="sidebar">
          ...
          <a href="listes des produits.php"><i class="fas fa-bag-shopping"></i>Listes des Produits</a>
          <a href="./www.w3schools.com/browsers/browsers_chrome.html"><i><img src="./images/w3c.jpg" style="width:30px;"></i>SITEGRATUIT</a>
  ...
  <?php
        ...
        $database = "ventestest";
          ...
          while($row = $result->fetch_assoc()) { ?>
            ...
            <td><?=$row["prix"]?></td>
            <td>
                <a href='modifierProduit.php'><div class='btn btn-info'>Modifier</div></a>
                <a href='supprimerProduit.php?referenceprod=<?=$row["referenceprod"]?>'>
